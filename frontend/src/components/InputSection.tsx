    ...
    <div className="flex flex-col h-full glass-sidebar p-6 w-80 shrink-0 overflow-y-auto">
      ...
      {activeTab === 'sdlc' ? (
        <div className="space-y-6">
          ...
          <form onSubmit={isConvertCodeEnabled ? handleConvertSubmit : handleSubmit} className="space-y-6">
            {/* File Upload Button */}
            {isConvertCodeEnabled && (
              <div className="space-y-2">
                <label className={`text-xs font-semibold uppercase tracking-wider flex items-center gap-2 ${isDark ? 'text-white/50' : 'text-gray-555'}`}>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {isParsingFile && (
                    <div className={`flex items-center gap-2 text-xs font-semibold ${isDark ? 'text-white/60' : 'text-gray-555'}`}>
            ...
            <CustomDropdown
              ...
              options={['gpt-4o', 'o3-mini', 'gemini-3.5-flash', 'mistral-large-latest', 'meta-llama/Llama-3.3-70B-Instruct-Turbo', 'Qwen/Qwen3.6-Plus', 'moonshotai/Kimi-K2.6', 'deepseek-ai/DeepSeek-V4-Pro']}
            ...
            <button
              type="submit"
              disabled={isLoading || estimateLoading || (isConvertCodeEnabled && isParsingFile) || (isConvertCodeEnabled && !formData.logic) || (inputGuardrails !== null && !inputGuardrails.passed)}
